        ...
        <div id="newForm" class="card pr-0 pl-0 fmb-bg-primary mt-1 col-md-8 offset-md-2 col-sm-10 offset-sm-1 col-12">
            <div id="newModule" class="card-block pr-0 pl-0 pb-0">
                ...
                <div class="d-flex justify-content-center ">
                    <p class="fmb-bg-message fmb-border-message text-center pl-4 pr-4 p-1">${moduleManager.module.name}<p>
                </div>
                ...
                <div class="d-flex justify-content-center title-box pt-3">
                    <a href="/moduleManager"><button v-on:click="addModule" type="button" class="btn color-button mb-1 bt-1 mt-0 fmb-border-message">Retour</button></a>
                </div>
