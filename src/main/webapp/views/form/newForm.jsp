            ...
            <div id="newForm" class="card-block pr-0 pl-0 pb-0">
                ...
                <div class="card-block fmb-card-content">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <i v-on:click="incrCurrentState()" class="fa fa-arrow-circle-right fmb-btn-arrow fa-3x" aria-hidden="true"></i>
                    </div>

                    <!-- Modal -->
                    <div class="modal fade scroll mt-0" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog mt-0" role="document">
                            ...
                            <div class="modal-content fmb-bg-primary">
                                ...
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title w-100" id="myModalLabel">Formulairse existants</h4>
                                </div>
                                <!--Body-->
