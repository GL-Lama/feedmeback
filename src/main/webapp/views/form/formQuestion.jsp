		...
		<div class="card pr-0 pl-0 fmb-bg-primary mt-1 col-md-8 offset-md-2 col-sm-10 offset-sm-1 col-12">
			<div id="formQuestion" class="card-block pr-0 pl-0 pb-0">
				...
				<c:forEach items="${formModel.questions}" var="question" varStatus="loop">
					<div v-show="isThisQuestion(${loop.index})" class="card-block fmb-card-content">
						<div class="d-flex justify-content-center text-center">
								...
								<c:forEach items="${formModel.getPropositions(loop.index)}" var="proposition" varStatus="loopProp">
									<div class="card-block fmb-card-content col-md-6 w-50">
										<label for="${proposition.numProposition}" class="w-100">
											...
											<p class="fmb-border-message fmb-bg-message p-2 pr-4 pl-4 lol w-100" >
						...
						<div v-if="${question.idType} === 5" class="row d-flex justify-content-center text-center mx-2">
							<div class="p-2 d-flex justify-content-center text-center w-100">
								<div class="fmb-border-message fmb-bg-message p-2 pt-2 pr-4 w-100">
									<div class="md-form w-100">
										<i class="fa fa-pencil prefix"></i>
										<textarea type="text" id="free-${question.numQuestion}" class="md-textarea"></textarea>
										<label for="free-${question.numQuestion}">Votre réponse</label>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="d-flex justify-content-between p-3">
					<i v-if="nbQuestion != 0" v-on:click="decrNbQuestion()" class="fa fa-arrow-circle-left fmb-btn-arrow fa-3x " aria-hidden="true"></i>
					<h4 v-else class="mt-1">Début</h4>

					<div class="compteur text-center m-0 align-self-center">
